Shader "RzShader/Rz_Distortion_Mesh" {
    Properties {
        ...
        _Y_DistortAmount ("Y_DistortAmount", Range(0, 1)) = 0
        _Z_RefractionAmount ("Z_RefractionAmount", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_5101 = ((node_8688+(((node_116.rgb+node_2698.rgb)/2.0).rg*_FlowStrength*abs(_Y_DistortAmount)))+_X_SlashOffset*float2(1,0));
                ...
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + (UV*(node_8211.b*node_6216.a)*_Z_RefractionAmount*_RefractionStrength);
